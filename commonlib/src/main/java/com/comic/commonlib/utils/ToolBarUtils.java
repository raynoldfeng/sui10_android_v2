    ...
    public static void adjustStatusBar(View view, Context context) {
        ...
        if (sdkInt >= Build.VERSION_CODES.KITKAT) {
            ...
            if (statusBar != null) {
                ...
                params.height = com.comic.commonlib.ui.utils.StatusBarUtils.getStatusBarHeight2(context);
            }
            if (viewParent instanceof RelativeLayout) {
                RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                        RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
                params.height = (int) (context.getResources().getDimension(
                        R.dimen.common_title_bar_height) + com.comic.commonlib.ui.utils.StatusBarUtils.getStatusBarHeight2(context));
